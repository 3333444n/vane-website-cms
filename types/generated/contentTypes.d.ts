...
export interface ApiAboutQuoteAboutQuote extends Struct.SingleTypeSchema {
...
export interface ApiAboutScrollItemAboutScrollItem
  extends Struct.CollectionTypeSchema {
...
export interface ApiAboutTextSectionAboutTextSection
  extends Struct.CollectionTypeSchema {
...
export interface ApiCertificationCertification
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    icon: Schema.Attribute.Media<'images' | 'videos' | 'files' | 'audios'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomepageQuoteHomepageQuote extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::homepage-quote.homepage-quote'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quote: Schema.Attribute.RichText & Schema.Attribute.Required;
